...
happyExpList = Happy_Data_Array.listArray (0,24) ([4064,1016,254,0,0,0,0,0,1016,0,64,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseProg","Prog","Op","'>'","'<'","'+'","'-'","'.'","','","'['","']'","%eof"]
        bit_start = st * 14
        bit_end = (st + 1) * 14
...
action_10 (14) = happyAccept
action_10 _ = happyFail (happyExpListPerState 10)

action_11 (13) = happyShift action_13
